    ...
    <div class="container py-2">
        ...
        <div class="row justify-content-center">
            <div class="col-5 d-flex align-items-center">
                <div>
                    <a href="/competencies/create" class="btn btn-primary btn-sm rounded-pill">
            ...
            <div class="col-md-8">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped caption-top">
                        {{-- Table caption --}}
                        <caption>List of competencies</caption>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline m-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="/competencies/{{ $competency->id }}/edit"
                                            ...
                                            <li class="list-inline-item">
                                                ...
                                                <form id="delete-form-{{ $competency->id }}"
                                                    action="/competencies/{{ $competency->id }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                ...
                {{ $competencies->onEachSide(1)->links() }}
            </div>
        </div>
    </div>
@endsection
